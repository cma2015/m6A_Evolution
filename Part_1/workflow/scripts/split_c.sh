...
samtools index -c -@ 5 ${OUTPATH}_fwd1.bam &&

samtools view -@ 5 -b -f 80 $DATA > ${OUTPATH}_fwd2.bam &&
samtools index -c -@ 5 ${OUTPATH}_fwd2.bam &&

#
# Combine alignments that originate on the forward strand.
#
samtools merge -@ 5 -f ${OUTPATH}_fwd.bam ${OUTPATH}_fwd1.bam ${OUTPATH}_fwd2.bam &&
samtools index -c -@ 5 ${OUTPATH}_fwd.bam &&

rm ${OUTPATH}_fwd1.bam ${OUTPATH}_fwd2.bam ${OUTPATH}_fwd1.bam.csi ${OUTPATH}_fwd2.bam.csi &
# Reverse strand
#
...
samtools index -c -@ 5 ${OUTPATH}_rev1.bam &&

samtools view -@ 5 -b -f 64 -F 16 $DATA > ${OUTPATH}_rev2.bam &&
samtools index -c -@ 5 ${OUTPATH}_rev2.bam &&
#
# Combine alignments that originate on the reverse strand.
#
samtools merge -@ 5 -f ${OUTPATH}_rev.bam ${OUTPATH}_rev1.bam ${OUTPATH}_rev2.bam &&
samtools index -c -@ 5 ${OUTPATH}_rev.bam &&

rm ${OUTPATH}_rev1.bam ${OUTPATH}_rev2.bam ${OUTPATH}_rev1.bam.csi ${OUTPATH}_rev2.bam.csi &
